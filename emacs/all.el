...
(load-file "~/projects/dotfiles/emacs/style.el")
...
(defun erc-default-join ()
  "Joins the freenode IRC with the default credentials.
Prompts for the password."
  (interactive)
  (let ()
    (erc :server "irc.freenode.org" :port 6667
         :nick "Forgetaboutit" :password (read-passwd "IRC-Password: " nil nil))))

(global-set-key (kbd "C-c C-e") 'erc-default-join)
